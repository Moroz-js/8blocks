...
export function Header({ locale }: HeaderProps) {
  ...
  const navigationLinks = [
    ...
    { href: locale === 'en' ? '/#about' : `/${locale}#about`, label: 'Team' },
  ];
  ...
  return (
    <>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-black lg:hidden overflow-y-auto pt-[3.125rem] lg:pt-[4.375rem]">
          <Container className="py-[40px] min-h-[calc(100vh-3.125rem)] lg:min-h-[calc(100vh-4.375rem)] flex flex-col justify-between">
            {/* Two Column Navigation */}
            <div className="grid grid-cols-2 gap-x-[30px] gap-y-[0px]">
              {/* Navigation Column */}
              <div className="flex flex-col gap-[10px]">
                <h3 className="font-berka font-medium text-[15px] leading-[1.5] text-white mb-[15px]">Navigation</h3>
              ...
              {/* Services Column */}
              <div className="flex flex-col gap-[10px]">
                <h3 className="font-berka font-medium text-[15px] leading-[1.5] text-white mb-[15px]">Services</h3>
                <nav className="flex flex-col gap-[12px]">
            ...
            <div className="flex gap-[40px] justify-center items-end pb-[40px]">
              {/* WhatsApp Button */}
              <a 
                href="https://wa.me/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex flex-col items-center gap-[12px] group"
              >
                <div className="relative w-[100px] h-[100px] flex items-center justify-center">
                  {/* Glow effect */}
                  <div className="absolute inset-0 rounded-full bg-[#75FB63] opacity-40 blur-[40px]" />
                  <div className="relative w-[80px] h-[80px] rounded-full bg-[#75FB63] flex items-center justify-center">
                ...
                <span className="font-berka text-[13px] leading-[1.5] text-[#75FB63]">Message us on WhatsApp</span>
              </a>
              ...
              >
                <div className="relative w-[100px] h-[100px] flex items-center justify-center">
                  ...
                  <div className="relative w-[80px] h-[80px] rounded-full bg-[#638EFB] flex items-center justify-center">
                ...
                <span className="font-berka text-[13px] leading-[1.5] text-[#638EFB]">Message us on Telegram</span>
              </a>
            </div>
          </Container>
        </div>
