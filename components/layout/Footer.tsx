...
export function Footer({ locale }: FooterProps) {
  ...
  return (
    <footer className="w-full bg-black py-[1.5625rem] md:py-[1.875rem]">
      <Container className="flex flex-col  ">
        {/* Top Section - Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[347px_386px_1fr] gap-[1.875rem] md:gap-[2.5rem] lg:gap-[40px]">
          {/* Newsletter */}
          ...
          <div className="relative flex gap-[1.25rem]">
            ...
            <div className="hidden lg:block absolute left-0 top-0 bottom-0 w-px bg-[rgba(255,255,255,0.07)]" />
            
            <div className="flex-1 flex gap-[1.25rem] lg:pl-[2.5rem]">
              {/* Navigation */}
          ...
          {/* Map - Desktop only */}
          <div className="mb-[2rem] hidden lg:block lg:justify-self-end">
        ...
        {/* Bottom */}
        <div className="mt-[2rem] flex flex-col md:flex-row items-center justify-between gap-[1.25rem] md:gap-[2.5rem]">
          <Logo />
          
          {/* Map - Mobile/Tablet only */}
          <div className="lg:hidden w-full md:w-auto">
            <div className="h-[230px] w-full overflow-hidden rounded-[0.5rem]" style={{boxShadow: '0px 0px 0px 1.592px rgba(0,0,0,0.2), 0px 0px 3.185px 0px rgba(0,0,0,0.08), 0px 3.185px 9.554px 0px rgba(0,0,0,0.1)'}}>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2244.3906!2d37.6173!3d55.7558!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNTXCsDQ1JzIwLjkiTiAzN8KwMzcnMDIuMyJF!5e0!3m2!1sen!2s!4v1234567890"
                width="100%"
                height="100%"
